...
const EarnedWageHero = () => {
    return (
        ...
        <div className="max-w-maximum flex flex-col md:flex-row justify-center items-center mx-auto">
            <div className="basis-1/2 p-4 pt-8">
            ...
            <div className="basis-1/2">
                <img className="mx-auto lg:h-[700px]" src="/images/home/hero.png" alt="hero" />
