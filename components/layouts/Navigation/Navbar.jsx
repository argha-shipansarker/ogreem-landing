        ...
        <nav className="bg-white px-2 sm:px-6 py-4 fixed w-full z-20 top-0 left-0 shadow-lg">
            <div className="flex flex-wrap items-center justify-between mx-auto">
                ...
                <Link href="https://play.google.com/store/apps/details?id=com.ogreem.app" target="_blank">
                    ...
                    <button className="inline-flex items-center bg-secondary p-2 ml-3 text-sm text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-200">
                        <svg
                        ...
                        <span className="justify-center hidden md:block pl-2">
                            Download App
                        </span>
                    </button>
