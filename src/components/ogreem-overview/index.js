  ...
  return (
    ...
    <div className="bg-primaryMuted py-16 px-9 ">
      ...
      <p className="lg:w-185 mt-2 mx-auto text-xl font-light text-center text-textMuted">
        Financial stress among employees is costing millions in lost
        productivity and high turnover. Ogreem gives employees immediate control
        over their own paycheck which increases productivity and motivation.
      </p>
